```aura width=860 height=200
 ...
 <div style={{ display:'flex', flexDirection:'column', marginLeft:168, gap:8, zIndex: 10 }}>
   ...
   <div style={{ display:'flex', fontSize:15, color:'rgba(180,165,255,0.8)', fontWeight:400, letterSpacing:'0.3px' }}>
     {github.user.bio || 'Full-Stack Developer · JavaScript · React · Node.js'}
   </div>
   <div style={{ display:'flex', gap:8, marginTop:6 }}>
     {['JavaScript', 'React', 'Node.js', 'MongoDB'].map(function(tag) {
       return (
         <div key={tag} style={{
...
(function() {
 ...
 return (
   <div style={{
     ...
     <style>
       {`
         @keyframes float-slow { 0%,100%{transform:translateX(0);opacity:.8} 50%{transform:translateX(350px);opacity:1.2} }
         @keyframes float-medium { 0%,100%{transform:translateX(0);opacity:.7} 50%{transform:translateX(-250px);opacity:1.1} }
         @keyframes float-fast { 0%,100%{transform:translateX(0);opacity:.9} 50%{transform:translateX(200px);opacity:.6} }
         @keyframes float-diagonal { 0%,100%{transform:translate(0,0);opacity:.75} 50%{transform:translate(120px,30px);opacity:1} }
         @keyframes float-wave { 0%,100%{transform:translateX(0);opacity:.65} 33%{transform:translateX(-160px);opacity:.9} 66%{transform:translateX(80px);opacity:1} }
         #glow-1{animation:float-slow 8s ease-in-out infinite}
         #glow-2{animation:float-medium 12s ease-in-out infinite}
         #glow-3{animation:float-fast 9s ease-in-out infinite}
     ...
     <svg width="860" height="140" style={{ position:'absolute', top:0, left:0 }}>
       <defs>
         <radialGradient id="g1" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(110,20,210,0.65)" /><stop offset="70%" stopColor="rgba(80,15,170,0)" />
         </radialGradient>
         <radialGradient id="g2" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(40,70,255,0.55)" /><stop offset="70%" stopColor="rgba(20,50,200,0)" />
         </radialGradient>
         <radialGradient id="g3" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(0,140,255,0.42)" /><stop offset="70%" stopColor="rgba(0,140,255,0)" />
         </radialGradient>
         <radialGradient id="g4" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(0,195,235,0.30)" /><stop offset="70%" stopColor="rgba(0,195,235,0)" />
         </radialGradient>
         <radialGradient id="g5" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(100,30,210,0.40)" /><stop offset="70%" stopColor="rgba(100,30,210,0)" />
         </radialGradient>
       </defs>
...
(function() {
 var categories = [
   { title: 'Languages', color: '#a78bfa', items: ['JavaScript', 'Java', 'Python', 'HTML5', 'CSS3'] },
   { title: 'Frontend',  color: '#60a5fa', items: ['React', 'Redux', 'TailwindCSS'] },
   { title: 'Backend',   color: '#34d399', items: ['Node.js', 'Express.js', 'Appwrite', 'Redis'] },
   { title: 'Database',  color: '#fb923c', items: ['MongoDB', 'Mongoose'] },
   { title: 'Tools',     color: '#f472b6', items: ['Git', 'GitHub', 'VS Code', 'Postman', 'Vercel', 'Render'] },
 ];
 ...
 return (
   <div style={{
     ...
     padding:'20px 32px', gap:12, borderRadius:16,
     ...
     <style>
       {`
         ...
         @keyframes float-diagonal { 0%,100%{transform:translate(0,0);opacity:.75} 50%{transform:translate(120px,30px);opacity:1} }
         @keyframes float-wave { 0%,100%{transform:translateX(0);opacity:.65} 33%{transform:translateX(-160px);opacity:.9} 66%{transform:translateX(80px);opacity:1} }
         @keyframes float-pulse { 0%,100%{transform:scale(1);opacity:.8} 50%{transform:scale(1.3);opacity:.4} }
     ...
     <svg width="860" height="280" style={{ position:'absolute', top:0, left:0 }}>
       <defs>
         <radialGradient id="g1" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(115,20,215,0.68)" /><stop offset="70%" stopColor="rgba(85,15,175,0)" />
         </radialGradient>
         <radialGradient id="g2" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(55,55,255,0.55)" /><stop offset="70%" stopColor="rgba(35,45,210,0)" />
         </radialGradient>
         <radialGradient id="g3" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(0,130,255,0.42)" /><stop offset="70%" stopColor="rgba(0,100,220,0)" />
         </radialGradient>
         <radialGradient id="g4" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(0,185,240,0.32)" /><stop offset="70%" stopColor="rgba(0,185,240,0)" />
         </radialGradient>
         <radialGradient id="g5" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(100,25,205,0.42)" /><stop offset="70%" stopColor="rgba(100,25,205,0)" />
         </radialGradient>
         <radialGradient id="g6" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(60,80,255,0.35)" /><stop offset="70%" stopColor="rgba(60,80,255,0)" />
         </radialGradient>
       </defs>
       <ellipse id="glow-1" cx="170" cy="280" rx="260" ry="200" fill="url(#g1)" />
       <ellipse id="glow-2" cx="320" cy="290" rx="220" ry="160" fill="url(#g2)" />
       <ellipse id="glow-3" cx="460" cy="290" rx="190" ry="150" fill="url(#g3)" />
       <ellipse id="glow-4" cx="590" cy="300" rx="160" ry="130" fill="url(#g4)" />
       <ellipse id="glow-5" cx="750" cy="300" rx="140" ry="120" fill="url(#g5)" />
       <ellipse id="glow-6" cx="420" cy="200" rx="100" ry="80"  fill="url(#g6)" />
     </svg>
       ...
       {categories.map(function(cat) {
         return (
           <div key={cat.title} style={{ display:'flex', alignItems:'center', gap:16 }}>
             <div style={{ display:'flex', fontSize:10, fontWeight:700, color:cat.color, letterSpacing:'1px', width:76, flexShrink:0 }}>
   ...
   <div style={{
     ...
     <style>
       {`
         ...
         #glow-3{animation:float-fast 8s ease-in-out infinite reverse}
       `}
     </style>
     <svg width="860" height="210" style={{ position:'absolute', top:0, left:0 }}>
       <defs>
         <radialGradient id="g1" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(110,20,210,0.55)" /><stop offset="70%" stopColor="rgba(90,15,180,0)" />
         </radialGradient>
         <radialGradient id="g2" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(40,60,255,0.45)" /><stop offset="70%" stopColor="rgba(30,50,200,0)" />
         </radialGradient>
         <radialGradient id="g3" cx="50%" cy="50%" r="50%">
           <stop offset="0%" stopColor="rgba(0,150,255,0.35)" /><stop offset="70%" stopColor="rgba(0,120,220,0)" />
         </radialGradient>
       </defs>
       <ellipse id="glow-1" cx="200" cy="240" rx="280" ry="200" fill="url(#g1)" />
       <ellipse id="glow-2" cx="440" cy="250" rx="200" ry="160" fill="url(#g2)" />
       <ellipse id="glow-3" cx="700" cy="240" rx="220" ry="180" fill="url(#g3)" />
     </svg>

     <div style={{ display:'flex', flexDirection:'column', alignItems:'center', zIndex:10, flex:1, padding:'20px 24px', gap:8 }}>
       <div style={{ fontSize:10, fontWeight:700, color:'rgba(155,140,210,0.5)', letterSpacing:'3px', marginBottom:6 }}>
         GITHUB STATS
       </div>
       <img
         src="https://github-readme-stats-fast.vercel.app/api?username=Soumyajitttt&show_icons=true&bg_color=00000000&title_color=a78bfa&text_color=c4b5fd&icon_color=60a5fa&hide_border=true&hide_rank=true"
         height={150}
         style={{ borderRadius:8 }}
       />
     </div>

     <div style={{ width:'1px', height:'160px', background:'rgba(255,255,255,0.06)', flexShrink:0 }} />
     ...
     <div style={{ display:'flex', flexDirection:'column', alignItems:'center', zIndex:10, flex:1, padding:'20px 24px', gap:8 }}>
       ...
       <img
         src="https://leetcard.jacoblin.cool/soumyaj1t?theme=dark&font=Recursive&ext=heatmap"
         height={150}
         style={{ borderRadius:8 }}
       />
     </div>
...
```aura width=120 height=44 link="https://www.linkedin.com/in/Soumyajitttt/" inline align=center
<SocialMediaButton
...
```aura width=110 height=44 link="mailto:your.email@gmail.com" inline align=center
<SocialMediaButton
...
```aura width=130 height=44 link="https://t.me/Soumyajitttt" inline align=center
<SocialMediaButton
